...
public class JavaUtils {
	 ...
	 * @Date 05/07/2018
	 * @Usage This method will delete a file from a directory based on the path
	 ...
	 * @Author Mohamed Nheri
	 * @Date 09/14/2018
	 * @Usage This method will delete all files with same extension provided under the 
	 * directory path provided
	 * @param folderPathOfTheFile
	 *            --> The path of the folder where the files are
	 * @param extensionOfTheFile
	 *            --> The extension of the file ex: {docx,html,log...}
	 * @Return N/A
	 * @throws Exception
	 */
	 ...
	 * @author mbn217
	 * @Date 04/20/2018
	 * @Purpose This method will generate Random Date example:("dd MMM yyyy", "18
	 *          Jul 2016", "20 Sep 2017")
	 * @param Format
	 * @param startDate
	 * @param endDate
	 * @return a String value of the random Date generated
	 ...
	 * @author mbn217
	 * @Date 05/20/2018
	 * @Purpose This method will Convert String[] to String
	 * @param str
	 *            --> input String [] for converting
	 * @param separator
	 *            --> separator. used while converting input String [] to String
