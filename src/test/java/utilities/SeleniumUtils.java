...
public class SeleniumUtils {
	 ...
	 * @author mbn217
	 * @Date 04/17/2018
	 * @Purpose This method will take two input to open the broswer and navigate to
	 *          the specified URL
	 * @param browserName
	 *            --> The type of browser you want to open
	 * @param baseURL
	 *            --> the URL to navigate
	 */
	public static void openBrowser(String browserName, String baseURL) {
		try {
			if (browserName.equalsIgnoreCase("Firefox")) {
				...
				System.setProperty("webdriver.ie.driver", "BrowserDrivers/IEDriverServer32.exe");
